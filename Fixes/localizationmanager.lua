...
Hooks:Add("LocalizationManagerPostInit", "SBLT_CUS_loc", function(...)
	LocalizationManager:add_localized_strings({
		...
		sblt_cus_returned_items = "The items has been returned to the inventory.",
		sblt_cus_stashed_items = "This items is hidden because it is incompatible with this version of the game or modified with incompatible items and will be returned when you launch the version where this item will be available.",
	...
	if Idstring("russian"):key() == SystemInfo:language():key() then
		LocalizationManager:add_localized_strings({
			...
			sblt_cus_returned_items = "Вещи были возвращены в инвентарь.",
			sblt_cus_stashed_items = "Эти предметы скрыты, поскольку они несовместимы с данной версией игры или модифицированы с использованием несовместимых предметов, и будут возвращены при запуске версии, в которой этот предмет будет доступен.",
